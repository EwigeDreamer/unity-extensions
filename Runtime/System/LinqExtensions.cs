...
namespace EwigeDreamer.Extensions.System
{
    public static class LinqExtensions
    {
        ...
        public static T RandomByWeight<T>(this IEnumerable<T> source, Func<T, int> getWeight, Random random = null) {
            ...
            random ??= RandomInternal;
            int sum = 0;
            for (int i = 0; i < list.Count; ++i) sum += getWeight(list[i]);
        ...
        public static T RandomByWeightOrDefault<T>(this IEnumerable<T> source, Func<T, int> getWeight, Random random = null) {
            if (source == null) throw new ArgumentNullException(nameof(source));
            if (getWeight == null) throw new ArgumentNullException(nameof(getWeight));
            var list = source.ToList();
            if (list.Count == 0) return default;
        ...
        public static T RandomByWeightOrDefault<T>(this IEnumerable<T> source, Func<T, float> getWeight, Random random = null) {
            if (source == null) throw new ArgumentNullException(nameof(source));
            if (getWeight == null) throw new ArgumentNullException(nameof(getWeight));
            var list = source.ToList();
            if (list.Count == 0) return default;
        ...
        public static IEnumerable<T> TakeRandom<T>(this IEnumerable<T> source, int count, Random random = null, bool allowRepeating = false) {
            if (source == null) throw new ArgumentNullException(nameof(source));
            var list = source.ToList();
        ...
        public static IEnumerable<T> TakeRandomByWeight<T>(this IEnumerable<T> source, Func<T, int> getWeight, int count, Random random = null, bool allowRepeating = false) {
            if (source == null) throw new ArgumentNullException(nameof(source));
            if (getWeight == null) throw new ArgumentNullException(nameof(getWeight));
            var list = source.ToList();
            if (list.Count == 0) yield break;
            ...
            T Next() {
                int sum = 0;
                for (int j = 0; j < list.Count; ++j) sum += getWeight(list[j]);
                var rnd = random.Next(1, sum + 1);
        ...
        public static IEnumerable<T> ToEnumerable<T>(this IEnumerable<T> source) => source;
